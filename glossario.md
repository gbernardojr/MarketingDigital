...
## **A**  
**A/B Testing (Teste A/B):** Comparação de duas versões de uma página, anúncio ou e-mail para ver qual tem melhor desempenho.
...
## **C**  
**CAC (Custo de Aquisição de Cliente):** Quanto uma empresa gasta para conquistar um novo cliente.  
...
**CRO (Conversion Rate Optimization):** Otimização de elementos em um site ou landing page para aumentar conversões.

---

## **D** 
**Dados de Primeira Parte (First-Party Data):** Informações coletadas diretamente do público (ex: dados de CRM, site analytics).
...
## **E**  
**E-mail Automation:** Envio automático de e-mails baseado em ações do usuário (ex: abandonou carrinho).
...
**Frequência (em Anúncios):** Número médio de vezes que um usuário vê um anúncio.
...
**Growth Hacking:** Técnicas criativas e de baixo custo para acelerar o crescimento de um negócio.
...
**Hyperlocal Marketing:** Estratégias direcionadas a um público em uma área geográfica muito específica.
...
**Lead Nurturing:** Processo de nutrir leads com conteúdo relevante até que estejam prontos para comprar.
...
**Marketplace:** Plataforma onde várias empresas vendem produtos (ex: Amazon, Mercado Livre).
...
**Mobile Marketing:** Estratégias voltadas para dispositivos móveis (SMS, apps, anúncios em redes sociais).
...
**Outbound Marketing:** Estratégias de marketing *tradicionais* e *interruptivas*, como cold calling, e-mails não solicitados (spam) e anúncios em TV/rádio/jornais. O oposto de **Inbound Marketing**.
...
**Programmatic Advertising:** Compra automatizada de espaços publicitários em tempo real (RTB – Real-Time Bidding).
...
## **S**
**Sales Funnel (Funil de Vendas):** Etapas que um cliente percorre desde o primeiro contato até a compra.
**SEO (Search Engine Optimization):** Otimização para motores de busca.  
**SERP (Search Engine Results Page):** Página de resultados do Google ou outro buscador.
...
**Trafego Pago vs. Orgânico:**  
- **Pago:** Visitantes provenientes de anúncios (Google Ads, Facebook Ads).  
- **Orgânico:** Visitantes que chegam sem custo (SEO, redes sociais, indicações).  


---

## **U**  
**UGC (User-Generated Content):** Conteúdo criado por usuários (ex: reviews, posts em redes sociais).
...
**Word-of-Mouth Marketing (Marketing Boca a Boca):** Quando clientes indicam uma marca espontaneamente.
